...
window.checkCollisions = function () {
	...
	allEnemies.forEach(function (enemy) {
		...
		var isLeftOverlap = enemy.collisionRight - player.collisionLeft > 0 && player.collisionRight - enemy.collisionLeft > 0;
		var overlap = isTopOverlap && isLeftOverlap;

		if (overlap) {
			(0, _sweetalert2.default)("You are eaten!", "Sorry! You are eaten by that scary bug.", "error");
